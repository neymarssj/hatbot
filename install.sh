...
if wget -q https://github.com/neymarssj/hatbot/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install yarn\ngit clone https://github.com/OFC-YOVANI/HATSUNE-MIKU\ncd HATSUNE-MIKU\nnpm install\nyarn install\nnpm start\033[0m"
exit 1
else
...
menu_ayuda() {
    #printf "${v1}[${b}++${v1}]${v} HATSUNE-MIKU${b}: "
	read opcion
	case $opcion in
            01|1)
...
echo -e "\033[01;32m\033[01mIniciando HATSUNE-MIKU!!\n\033[0m"
npm start
